...
def predict(city, occupation, dependents, income, age, loan_repayment, insurance, rent):
    ...
    Education_out_result = Education_model.predict([[
    ...
    Miscellaneous_care_result = Miscellaneous_care_model.predict([[
    ...
    print('hii',Groceries_result,Eating_out_result,Education_out_result,Entertainment_result,
          Health_care_result,Miscellaneous_care_result,Transport_result,Utilities_result)
    return Groceries_result[0],Eating_out_result[0],Education_out_result[0],Entertainment_result[0],Health_care_result[0],Miscellaneous_care_result[0],Transport_result[0],Utilities_result[0]
predict("Tier_1","Self_Employed","2","50000","25","5000","2000","20000")

def algo_ml(Groceries_result,Eating_out_result,Education_out_result,Entertainment_result,
          Health_care_result,Miscellaneous_care_result,Transport_result,Utilities_result,Desired_saving,Income):
    expense = Groceries_result+Eating_out_result+Education_out_result+Entertainment_result+Health_care_result+Miscellaneous_care_result+Transport_result+Utilities_result
    sv=Income-expense
    ...
    aed=Education_out_result-(Education_out_result*x)
    aet=Entertainment_result-(Entertainment_result*x)
    ahc=Health_care_result-(Health_care_result*x)
    amc=Miscellaneous_care_result-(Miscellaneous_care_result*x)
    atr=Transport_result-(Transport_result*x)
    aut=Utilities_result-(Utilities_result*x)
    #store  the result in the dicrtionary
    result = {
        "Groceries":agr,
        "Eating_out":aeo,
        "Education":aed,
